...
public class BfsDfs {
    ...
    private void printStack(TreeNode root){
    	Stack<TreeNode> stack = new Stack<>();
    	stack.push(root);
    	while(!stack.isEmpty()){
    		System.out.println("Stack print : "+stack.pop().val);
    	}
    ...
    public static void main(String[] args){
    	BfsDfs ob = new BfsDfs();
    	TreeNode tree = ob.createSampleTree();
    	ob.serialize_using_bfs(tree);
    	System.out.println("BFS ENDS");
    	ob.serialize_using_dfs(ob.createSampleTree());
